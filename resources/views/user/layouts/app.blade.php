...
<body>
		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href=""><img src="{{ asset('user/img/logo.png') }}" alt=""></a>
		...
		<div class="container">
			...
			<div class="footer-bottom d-flex justify-content-center align-items-center flex-wrap">
				<p class="footer-text m-0">
                    Copyright &copy;<script>document.write(new Date().getFullYear());</script><i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="http://127.0.0.1:8000/" target="_blank">EShop</a>
                </p>
			</div>
		</div>
	</footer>
	...
	<script src="{{ asset('user/js/vendor/bootstrap.mi') }}n.js"></script>
